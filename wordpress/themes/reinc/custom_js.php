function generateContentGrid(associate_type, paged, associate_category){
	...
	wpCollections.each( function( post ) {
		...
		jQuery("#associate_results").append("<div class=\"associate_item col-xs-3 col-sm-3 col-md-3\">" +
			"<div class=\"flip-container\" ontouchstart=\"this.classList.toggle('hover');\">"+
				"<div class=\"front\">" +
					"<a class=\"link\" href=\""+post.attributes.link+"\">"+frontContent+"</a>" +
				"</div>" +
			"</div>"+
			"<a class=\"link\" href=\""+post.attributes.link+"\"><h3 class=\"h3\">"+post.attributes.title.rendered+"</h3></a>" +
			"</div>");
		});
