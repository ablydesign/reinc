var ASSOCIADOS_SINGLE = (function ($, window, document, undefined) {
	...
	var filter = [],
		...
		url_action = 'http://www.reinc.org.br/wp-json/reinc-api/v1/get_empresas_per_parque';

	var incubadora_id = $('#empresas_parques').data('parque-id');
	...
	associados_single.init = function(){
		console.log("[PARQUE_SINGLE] : Init");
		get_json_associates();
		on_click_filter();
		toggle_content();
