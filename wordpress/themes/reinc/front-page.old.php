                ...
                <section class="numbers-reinc col-xs-12 col-sm-6 col-md-6">
                    <div class="row">
                		...
                		<div class="content-numbers">
            				<i class="icon-numbers icon-incubadoras col-xs-2"></i>
            			...
            			<div class="content-numbers">
            				<i class="icon-numbers icon-parques-tecnologicos col-xs-2"></i>
            				<div class="content-text-reinc col-xs-8">
            			...
            			<div class="content-numbers">
            				<i class="icon-numbers icon-empresas-incubadas col-xs-2"></i>
            				<div class="content-text-reinc col-xs-8">
                        ...
                        <!--
            			<div class="content-numbers">
            				<i class="icon-numbers icon-empresas-graduadas col-xs-2"></i>
            				<div class="content-text-reinc col-xs-8">
            					<span class="text-numbers-reinc"><?php echo __("Empresas<br/>Graduadas", 'natio-lang'); ?></span>
            				</div>
            				<div class="number col-xs-2">
            					<span class="numbers"><?php echo $totalEmpresasGraduadas; ?></span>
            				</div>
            			</div>
                        <div class="content-numbers">
            				<i class="icon-numbers icon-empresas-graduadas col-xs-2"></i>
            				<div class="content-text-reinc col-xs-8">
            					<span class="text-numbers-reinc"><?php echo __("Empresas<br/>Associadas", 'natio-lang'); ?></span>
            				</div>
            				<div class="number col-xs-2">
            					<span class="numbers"><?php echo $associados_infor['empresas']['associadas']['count'] ?></span>
            				</div>
            			</div>
                        <div class="content-numbers">
            				<i class="icon-numbers icon-empresas-graduadas col-xs-2"></i>
            				<div class="content-text-reinc col-xs-8">
            					<span class="text-numbers-reinc"><?php echo __("Empresas<br/>Instaladas", 'natio-lang'); ?></span>
            				</div>
            				<div class="number col-xs-2">
            					<span class="numbers"><?php echo $associados_infor['empresas']['instaladas']['count'] ?></span>
            				</div>
            			</div>
            			<div class="full-width">
            				<div class="col-xs-12">
            					<a href="<?php echo get_permalink(get_page_by_path( 'associados' ) ); ?>" class="VejaMais"><?php echo __("Veja Mais >",  'natio-lang'); ?></a>
            				</div>
            			</div> -->

                        <?php
            			/*
            			<div class="content-numbers col-xs-12 col-sm-6 col-md-6">
                            <i class="icon-numbers icon-empresas-graduadas"></i>
                            <div class="content-text-reinc col-xs-12 col-sm-8 col-md-8">
                                <span class="text-numbers-reinc">Empresas <br/>Incubadas</span>
                            </div>
                            <div class="col-xs-12 col-sm-2 col-md-2">
                                <span class="numbers">224</span>
                            </div>
                        </div>
            			*/
            			?>
