    ...
    <div class="container" id="search-page">
        <div class="row">
            <section class="col-xs-12 content-internal-pages">
                <h1 class="title-default"><?php _e('Busca', 'natio-lang'); ?></h1>
                <?php if (have_posts()) : ?>
                    <div class="loop-container post-loop search-loop">
                        <h2><?php echo (sprintf(__('Foram encotrados %1$d resultados para: <b>%2$s</b>', 'natio-lang'), $wp_query->post_count, get_search_query()) );?></h2>
